...
console.log("\nEmp Wage with reduce: "+empDailyWageArr.reduce(totalWages,0));
...
console.log("\nFirst time Fulltime wage was earned on Day: "+mapDayWithWageArr.find(findFulltimeWage));
...
console.log("\nCheck If All Elements have Full Time Wage: "+fullDayWageArr.every(isAllFulltimeWage));
...
console.log("\nNumber of Days Emp Worked: "+empDailyWageArr.reduce(totalDaysWorked));